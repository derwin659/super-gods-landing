  ...
  return (
    <form onSubmit={handleSubmit} className="p-8 md:p-12">
      ...
      <div className="mt-8 grid gap-5">
        ...
        <label className="grid gap-2">
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            placeholder="Ej: Quiero ordenar mis reservas, caja y pagos a profesionales."
      ...
      <p className="mt-4 text-center text-xs font-semibold leading-5 text-slate-500">
        No necesitas tarjeta. Primero revisamos tu solicitud para activar una demo real de Super Gods.
      </p>
    </form>
  );
}
