...
class _AccountMiniError extends StatelessWidget {
  final String message;
  final VoidCallback onRetry;

  const _AccountMiniError({
...
class _AccountStatusBanner extends StatelessWidget {
  ...
  IconData get _icon {
    ...
    if (subscription.isTrial) return Icons.verified_user_rounded;
  ...
  String get _subtitle {
    ...
    if (subscription.isTrial) {
      return "Esta cuenta está habilitada para evaluación operativa.";
    }
        ...
        children: [
          ...
          if ((subscription.fechaRenovacion ?? '').trim().isNotEmpty) ...[
            ...
            Align(
              alignment: Alignment.centerLeft,
              child: Text(
                "Vigencia: ${subscription.fechaRenovacion}",
                style: TextStyle(
                  fontSize: 11.2,
                  fontWeight: FontWeight.w700,
